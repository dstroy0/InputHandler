...
class MainWindow(QMainWindow):
    ...
    def loading_splashscreen(self):
        self.loading_dlg = QDialog(self)
        self.splash = QSplashScreen(QPixmap(self.lib_root_path + "/docs/img/_Logolarge.png"))
        self.loading_dlg.splash = self.splash
        self.loading_dlg.splash.show()
# loop

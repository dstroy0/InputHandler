...
def command_settings_setup(self):
    ...
    self.ui.commandArgumentCSV.setValidator(regex_validator("^([,]|UINT8_T|UINT16_T|UINT32_T|FLOAT|CHAR|STARTSTOP)+$"))
    self.ui.commandArgumentCSV.setPlaceholderText("UINT8_T,UINT16_T,UINT32_T,FLOAT,CHAR,STARTSTOP...")

...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # MainWindow var
        self.file_first_line = '# Generated by InputHandler\'s cli_gen_tool.py version ' + str(version)
        self.docs_format_string = """##
# @file {}
# @author Douglas Quigg (dstroy0 dquigg123@gmail.com)
# @brief {}
# @version {}
...
# modify it under the terms of the GNU General Public License
# version 3 as published by the Free Software Foundation."""
        self.docs_format_string_format_list = ['filename_ph',
                                               'brief_ph',
                                               'version_ph',
                                               datetime.date.today(),
                                               str(datetime.date.today())[0:4],
                                               str(datetime.date.today())[0:4]]
        # print(self.docs_format_string.format(*self.docs_format_string_format_list))

...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.windowLogLevelComboBox.setItemText(0, QCoreApplication.translate("Preferences", u"DEBUG", None))
        self.windowLogLevelComboBox.setItemText(1, QCoreApplication.translate("Preferences", u"INFO", None))
        self.windowLogLevelComboBox.setItemText(2, QCoreApplication.translate("Preferences", u"WARNING", None))
        self.windowLogLevelComboBox.setItemText(3, QCoreApplication.translate("Preferences", u"ERROR", None))
        self.windowLogLevelComboBox.setItemText(4, QCoreApplication.translate("Preferences", u"CRITICAL", None))
        ...
        self.fileLogLevelComboBox.setItemText(0, QCoreApplication.translate("Preferences", u"DEBUG", None))
        self.fileLogLevelComboBox.setItemText(1, QCoreApplication.translate("Preferences", u"INFO", None))
        self.fileLogLevelComboBox.setItemText(2, QCoreApplication.translate("Preferences", u"WARNING", None))
        self.fileLogLevelComboBox.setItemText(3, QCoreApplication.translate("Preferences", u"ERROR", None))
        self.fileLogLevelComboBox.setItemText(4, QCoreApplication.translate("Preferences", u"CRITICAL", None))

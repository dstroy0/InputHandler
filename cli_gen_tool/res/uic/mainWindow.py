...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.default_setting_button, 2, 2, 1, 1)
        ...
        self.cmd_settings_menu_button = QPushButton(self.command_tab)
        self.cmd_settings_menu_button.setObjectName(u"cmd_settings_menu_button")
        self.cmd_settings_menu_button.setMaximumSize(QSize(170, 16777215))
        ...
        self.edit_cmd_button = QPushButton(self.command_tab)
        self.edit_cmd_button.setObjectName(u"edit_cmd_button")
        self.edit_cmd_button.setMinimumSize(QSize(265, 0))

        self.gridLayout_2.addWidget(self.edit_cmd_button, 3, 1, 1, 1)
        ...
        self.delete_cmd_button = QPushButton(self.command_tab)
        self.delete_cmd_button.setObjectName(u"delete_cmd_button")

        self.gridLayout_2.addWidget(self.delete_cmd_button, 3, 2, 1, 1)
        ...
        QWidget.setTabOrder(self.delete_cmd_button, self.tabWidget)

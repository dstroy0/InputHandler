...
class Ui_commandParametersDialog(object):
    def setupUi(self, commandParametersDialog):
        ...
        commandParametersDialog.resize(724, 418)
        ...
        self.argumentsPane.setMinimumSize(QSize(375, 400))
        ...
        self.commandMaxArgsLabel.setMinimumSize(QSize(125, 0))
        ...
        self.gridLayout_2.addWidget(self.commandMaxArgsLabel, 1, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.label_9, 0, 0, 1, 3)
        ...
        self.argumentsPlainTextCSV.setMinimumSize(QSize(0, 300))
        self.argumentsPlainTextCSV.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)

        self.gridLayout_2.addWidget(self.argumentsPlainTextCSV, 2, 3, 9, 1)
        ...
        self.gridLayout.addWidget(self.argumentsPane, 1, 3, 1, 1)

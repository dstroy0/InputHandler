...
class Ui_commandParametersDialog(object):
    def setupUi(self, commandParametersDialog):
        ...
        self.gridLayout_2.addWidget(self.rem, 4, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem1, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.add16bituint, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.add32bituint, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem2, 6, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.add16bitint, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem3, 7, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem4, 8, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.addfloat, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.addstartstop, 10, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem6, 10, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem5, 9, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.addchar, 9, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.rem7, 11, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.addnotype, 11, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.commandMinArgs, 0, 3, 1, 1)

        self.commandMaxArgs = QSpinBox(self.argumentsPane)
        self.commandMaxArgs.setObjectName(u"commandMaxArgs")

        self.gridLayout_2.addWidget(self.commandMaxArgs, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.commandMaxArgsLabel, 1, 0, 1, 2)

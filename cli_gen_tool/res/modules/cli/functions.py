...
class cliFunctions(object):
    ...
    def functions_h(self, item_string, place_cursor=False):
        ...
        functions_h_prototype_string = filestring_db["functions"]["h"][
    ...
    def functions_cpp(self, item_string, place_cursor=False):
        ...
        code_string = self.list_to_code_string(docstring)
        cpp_fs = filestring_db["functions"]["cpp"]["filestring"]
        func_string = filestring_db["functions"]["cpp"]["filestring components"][
            "function"
        ]
        func_list = []

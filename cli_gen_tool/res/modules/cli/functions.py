...
class cliFunctions(object):
    ...
    def functions_h(self, item_string, place_cursor=False):
        ...
        functions_h_fs = CLIfilestrings.db["functions"]["h"]["filestring"]
        functions_h_prototype_string = CLIfilestrings.db["functions"]["h"][
    ...
    def functions_cpp(self, item_string, place_cursor=False):
        ...
        code_string = self.list_to_code_string(docstring)
        cpp_fs = CLIfilestrings.db["functions"]["cpp"]["filestring"]
        func_string = CLIfilestrings.db["functions"]["cpp"]["filestring components"][
            "function"
        ]
        func_list = []
        ...
        if self.cliOpt["builtin methods"]["var"]["defaultFunction"] == True:
            ...
            statement = CLIfilestrings.db["functions"]["cpp"]["filestring components"][
                "outputToStream"

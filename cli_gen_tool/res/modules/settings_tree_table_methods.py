...
def add_settings_tree_table_row(
    ...
    set_table_vertical_labels(tree, dict_key2, new_row)
...
def build_tree_table_widget(
    ...
    table_widget.itemPressed.connect(edit_table_widget_item)
    table_widget.itemChanged.connect(table_widget_item_changed)

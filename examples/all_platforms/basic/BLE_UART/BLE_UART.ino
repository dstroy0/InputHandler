/*
    ...
    This example was built on the Adafruit bleuart_cmdmode example:
    https://github.com/adafruit/Adafruit_BluefruitLE_nRF51/tree/master/examples/bleuart_cmdmode

    Adafruit license: https://github.com/adafruit/Adafruit_nRF52_Arduino/blob/master/LICENSE

    InputHandler docs: https://dstroy0.github.io/InputHandler/html/index.html

...
*/
const PROGMEM ih::Parameters listCommands_param[1] = {listCommands,                 // function pointer
...
*/
const PROGMEM ih::Parameters listSettings_param[1] = {listSettings,                 // function pointer
                                                      ih::no_wildcards,             // wildcard flag

...
project = "InputHandler Library"
copyright = "2022 Douglas Quigg"
author = "dstroy0"

# The full version, including alpha/beta/rc tags
release = "1.0.0"  # the minimum version that supports sphinx builds and RTD hosting
...
breathe_projects = {"InputHandler": "xml"}
...
html_theme_options = {
    ...
    "repo_url": "https://github.com/dstroy0/InputHandler",
...
html_title = "InputHandler Arduino Library"

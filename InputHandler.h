...
public:
    ...
    void GetCommandFromStream(HardwareSerial& stream, uint16_t rx_buffer_size = 128, const char* end_of_line_character = _default_end_of_line_character);
...
private:
    ...
    static constexpr const char* null_ = "\0";
    static constexpr const char* _default_username = "user";
    static constexpr const char* _default_end_of_line_character = "\r\n";
    static constexpr const char* _default_token_delimiter = " ";
    static constexpr const char* _default_c_string_delimiter = "\"";

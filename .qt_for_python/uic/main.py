...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inputhandler_settings_table.setGeometry(QRect(10, 20, 771, 761))
        self.inputhandler_settings_table.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        self.inputhandler_settings_table.horizontalHeader().setVisible(False)
        ...
        self.label_4 = QLabel(self.ih_settings_tab)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(330, 0, 121, 21))
        ...
        self.treeView.setGeometry(QRect(10, 20, 771, 761))
        ...
        self.label_2.setGeometry(QRect(1070, 0, 121, 21))
        ...
        self.deleteButton = QPushButton(self.command_tab)
        self.deleteButton.setObjectName(u"deleteButton")
        self.deleteButton.setGeometry(QRect(450, 790, 121, 31))
        ...
        self.newButton = QPushButton(self.command_tab)
        self.newButton.setObjectName(u"newButton")
        self.newButton.setGeometry(QRect(190, 790, 121, 31))
        self.label_3 = QLabel(self.command_tab)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(320, 0, 121, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Commands", None))

...
class Ui_commandParametersDialog(object):
    def setupUi(self, commandParametersDialog):
        ...
        self.label_11.setMinimumSize(QSize(150, 24))
        self.label_11.setMaximumSize(QSize(150, 24))
        ...
        self.commandString.setMinimumSize(QSize(75, 24))
        self.commandString.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.commandString, 0, 1, 1, 2)

        self.label_13 = QLabel(self.parametersPane)
        self.label_13.setObjectName(u"label_13")
        sizePolicy.setHeightForWidth(self.label_13.sizePolicy().hasHeightForWidth())
        self.label_13.setSizePolicy(sizePolicy)
        self.label_13.setMinimumSize(QSize(150, 24))
        self.label_13.setMaximumSize(QSize(150, 24))
        ...
        self.commandLengthLabel.setMinimumSize(QSize(75, 24))
        self.commandLengthLabel.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.commandLengthLabel, 1, 1, 1, 2)
        ...
        self.commandParentId.setMinimumSize(QSize(75, 24))
        self.commandParentId.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.commandParentId, 2, 1, 1, 2)

        self.label_14 = QLabel(self.parametersPane)
        self.label_14.setObjectName(u"label_14")
        sizePolicy.setHeightForWidth(self.label_14.sizePolicy().hasHeightForWidth())
        self.label_14.setSizePolicy(sizePolicy)
        self.label_14.setMinimumSize(QSize(150, 24))
        ...
        self.label_17.setMinimumSize(QSize(200, 24))
        self.label_17.setMaximumSize(QSize(200, 24))
        ...
        self.commandHasWildcards.setMinimumSize(QSize(20, 24))
        self.commandHasWildcards.setMaximumSize(QSize(16777215, 24))
        self.commandHasWildcards.setToolTipDuration(1)

        self.gridLayout_2.addWidget(self.commandHasWildcards, 5, 2, 1, 1)

        self.label_12 = QLabel(self.parametersPane)
        self.label_12.setObjectName(u"label_12")
        sizePolicy.setHeightForWidth(self.label_12.sizePolicy().hasHeightForWidth())
        self.label_12.setSizePolicy(sizePolicy)
        self.label_12.setMinimumSize(QSize(200, 24))
        self.label_12.setMaximumSize(QSize(200, 24))
        ...
        self.commandDepth.setMinimumSize(QSize(75, 24))
        self.commandDepth.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.commandDepth, 6, 2, 1, 1)
        ...
        self.commandSubcommands_label.setMinimumSize(QSize(200, 24))
        self.commandSubcommands_label.setMaximumSize(QSize(200, 24))
        self.commandSubcommands_label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_2.addWidget(self.commandSubcommands_label, 7, 0, 1, 2)
        ...
        self.commandSubcommands.setMinimumSize(QSize(75, 24))
        self.commandSubcommands.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.commandSubcommands, 7, 2, 1, 1)

        self.label_16 = QLabel(self.parametersPane)
        self.label_16.setObjectName(u"label_16")
        sizePolicy.setHeightForWidth(self.label_16.sizePolicy().hasHeightForWidth())
        self.label_16.setSizePolicy(sizePolicy)
        self.label_16.setMinimumSize(QSize(150, 24))
        self.label_16.setMaximumSize(QSize(150, 24))
        ...
        self.commandArgumentHandling.setMinimumSize(QSize(75, 24))
        self.commandArgumentHandling.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.commandArgumentHandling, 8, 1, 1, 2)

        self.label_10 = QLabel(self.parametersPane)
        self.label_10.setObjectName(u"label_10")
        sizePolicy.setHeightForWidth(self.label_10.sizePolicy().hasHeightForWidth())
        self.label_10.setSizePolicy(sizePolicy)
        self.label_10.setMinimumSize(QSize(150, 24))
        self.label_10.setMaximumSize(QSize(150, 24))
        ...
        self.returnFunctionName.setMinimumSize(QSize(75, 24))
        self.returnFunctionName.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_2.addWidget(self.returnFunctionName, 9, 1, 1, 2)
        ...
        self.label_15.setMaximumSize(QSize(150, 20))
    ...
    def retranslateUi(self, commandParametersDialog):
        ...
        self.label_14.setText(QCoreApplication.translate("commandParametersDialog", u"This command's id#: ", None))
        self.label_17.setText(QCoreApplication.translate("commandParametersDialog", u"This command contains wildcard(s): ", None))
#if QT_CONFIG(tooltip)
        self.commandHasWildcards.setToolTip(QCoreApplication.translate("commandParametersDialog", u"Yes if checked", None))
#endif // QT_CONFIG(tooltip)
        self.commandHasWildcards.setText("")
        self.label_12.setText(QCoreApplication.translate("commandParametersDialog", u"This Command's depth in the tree ", None))
        self.commandSubcommands_label.setText(QCoreApplication.translate("commandParametersDialog", u"Number of subcmd this cmd has", None))
        self.label_16.setText(QCoreApplication.translate("commandParametersDialog", u"Cmd arg. handling", None))
        ...
        self.label_10.setText(QCoreApplication.translate("commandParametersDialog", u"Callback function name", None))
        self.returnFunctionName.setPlaceholderText(QCoreApplication.translate("commandParametersDialog", u"No callback...", None))
        self.label_15.setText(QCoreApplication.translate("commandParametersDialog", u"Parent command id#: ", None))

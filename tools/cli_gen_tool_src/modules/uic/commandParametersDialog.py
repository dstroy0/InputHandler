...
class Ui_commandParametersDialog(object):
    def setupUi(self, commandParametersDialog):
        ...
        self.gridLayout_3.addWidget(self.returnFunctionName, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.commandMinArgs, 0, 1, 1, 1)

        self.argLineEdit = QLineEdit(self.argumentsPane)
        self.argLineEdit.setObjectName(u"argLineEdit")
        sizePolicy2 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.argLineEdit.sizePolicy().hasHeightForWidth())
        self.argLineEdit.setSizePolicy(sizePolicy2)
        self.argLineEdit.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)

        self.gridLayout_2.addWidget(self.argLineEdit, 3, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.commandMaxArgsLabel, 0, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.commandMaxArgs, 0, 3, 1, 1)

        self.argTable = QTableWidget(self.argumentsPane)
        self.argTable.setObjectName(u"argTable")

        self.gridLayout_2.addWidget(self.argTable, 1, 0, 1, 5)
    ...
    def retranslateUi(self, commandParametersDialog):
        ...
        self.argLineEdit.setPlaceholderText(QCoreApplication.translate("commandParametersDialog", u"Enter a valid UITYPE argument...", None))

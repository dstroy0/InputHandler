...
class ParseInputHandlerConfig(object):
    ...
    def parse_config_header_file(self, path: str):
        ...
        debug_regexp = r"(\s*#define\s*)(DEBUG_\S* )(\S*.*)"
        opt_method_regexp = r"(\s*#define\s*)(DISABLE_\S* )(\S*.*)"
        setting_regexp = r"(\s*#define\s*)(?!\S*PGM_LEN)(IH_\S*\s*)(\d*.*)"
        progmem_regexp = r"(\s*#define\s*)(IH_\S*PGM_LEN\s*)(\d*.*)"
        regexp_dict = {

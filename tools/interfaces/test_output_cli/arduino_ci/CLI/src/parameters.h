...
/**
   @brief CommandParameters struct for testb_4
*/
const PROGMEM CommandParameters testb_4_param[1] = 
{
...
/**
   @brief CommandParameters struct for testc_5
*/
const PROGMEM CommandParameters testc_5_param[1] = 
{
...
/**
   @brief CommandParameters struct for testd_6
*/
const PROGMEM CommandParameters testd_6_param[1] = 
{
...
/**
   @brief CommandParameters struct for teste_7
*/
const PROGMEM CommandParameters teste_7_param[1] = 
{
...
/**
   @brief CommandParameters struct for testf_8
*/
const PROGMEM CommandParameters testf_8_param[1] = 
{
...
/**
   @brief CommandParameters struct for testg_9
*/
const PROGMEM CommandParameters testg_9_param[1] = 
{
...
*/
const PROGMEM CommandParameters test_2_param[1 /* root */ + 7 /* child(ren) */] = 
{
    {
...
CommandConstructor test_2_(test_2_param, nprms(test_2_param), 6); // test_2_ command constructor

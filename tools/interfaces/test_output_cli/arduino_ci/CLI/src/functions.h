...
void unrecognized(ih::UserInput* _inputHandler){ _inputHandler->outputToStream(Serial);}
void listCommands(ih::UserInput* _inputHandler){ _inputHandler->listCommands();}
void listSettings(ih::UserInput* _inputHandler){ _inputHandler->listSettings();}
